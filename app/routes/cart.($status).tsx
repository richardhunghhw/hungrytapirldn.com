...
export async function action({ request, context }: HTActionArgs) {
	...
	const checkoutLineItems = [
		{ price: 'price_1MydK6LNU8oiV5Be0omfpEG3', quantity: Number(formData.get('kaya-signature-quantity')) },
		{ price: 'price_1MyeCKLNU8oiV5BealclK5xS', quantity: Number(formData.get('kaya-vegan-quantity')) },
	...
	if (!checkoutSession?.url) throw new Error('Unable to create Stripe Checkout Session.');
			...
			<div className='h-full max-w-screen-lg sm:mx-12 md:mx-24 lg:mx-48 xl:mx-auto'>
				<div className='flex h-full flex-col overflow-y-auto bg-white shadow-xl'>
					...
					<div className='flex justify-between px-4 py-6'>
						<div className='text-lg font-medium text-gray-900'>Order Form</div>
